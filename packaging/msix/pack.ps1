<#
  ...
  -BurritoExe  Path to the Burrito output exe (burrito_out/fabric_platform_central_windows.exe)
  ...
  ex: pwsh packaging/msix/pack.ps1 -BurritoExe burrito_out/fabric_platform_central_windows.exe -Version 0.1.0.1
#>
[CmdletBinding()]
param(
